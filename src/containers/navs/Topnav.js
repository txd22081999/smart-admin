          ...
          <div className='user d-inline-block'>
            <UncontrolledDropdown className='dropdown-menu-right'>
              <DropdownToggle className='p-0' color='empty'>
                <span className='name mr-1'>{user?.username || 'Admin'}</span>
                <span>
                  ...
                  <img
                    ...
                    src={
                      ...
                      'https://thumbs.dreamstime.com/b/business-concept-jacket-tie-cravat-suit-wedding-men-s-clothing-dress-clothes-representative-idea-icon-black-color-180287428.jpg'
                      // coverImageUrl ||
